...
import { ArrowRight, X, MapPin, Compass, Info } from "lucide-react";
...
const destinations = [
    {
        ...
        tag: "Sacred Valley",
        description: "Home to the legendary Tiger's Nest Monastery, Paro is a wide and verdant valley with a rich history and a blend of traditional and modern charm. It serves as the gateway to Bhutan for most international travelers.",
        details: ["Tiger's Nest Monastery", "National Museum", "Paro Rinpung Dzong", "Kyichu Lhakhang"]
    },
    {
        name: "Thimphu",
        image: "https://images.unsplash.com/photo-1506461883276-594a12b11cf3?q=80&w=2070&auto=format&fit=crop",
        tag: "Capital City",
        description: "The unique capital of Bhutan, where traditional culture meets modernity. Thimphu is the only capital in the world without a single traffic light, yet it hums with vibrant energy, art, and political life.",
        details: ["Memorial Chorten", "Buddha Dordenma", "Tashichho Dzong", "Authentic Bhutanese Crafts"]
    },
    {
        name: "Punakha",
        image: "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?q=80&w=2070&auto=format&fit=crop",
        tag: "Ancient Capital",
        description: "Located at the confluence of the Pho Chhu and Mo Chhu rivers, Punakha is famous for its stunning Dzong—one of the most beautiful in Bhutan—and its subtropical valleys perfect for rice cultivation.",
        details: ["Punakha Dzong", "Chimi Lhakhang", "Suspension Bridge", "Khamsum Yulley Namgyal"]
    },
    {
        name: "Phuntsholing",
        image: "https://images.unsplash.com/photo-1524222717473-730000096953?q=80&w=2070&auto=format&fit=crop",
        tag: "Gateway to India",
        description: "Situated on the border with India, Phuntsholing is a bustling commercial hub. It offers a fascinating mix of Bhutanese and Indian cultures and is the starting point for road journeys into the interior.",
        details: ["Amo Chhu Crocodile Farm", "Karbandi Monastery", "Zangtho Pelri Lhakhang", "Border Gate"]
    },
    {
        name: "Wangdue",
        image: "https://images.unsplash.com/photo-1623091410901-00e2d268901f?q=80&w=2070&auto=format&fit=crop",
        tag: "Cultural Heartland",
        description: "Known for its bamboo work and slate carvings, Wangdue Phodrang is a bridge to central Bhutan. The valley is characterized by its dramatic ridges and the reconstruction of its historic fortress.",
        details: ["Wangdue Phodrang Dzong", "Radak Neykhang", "Phobjikha Valley nearby", "Local Bamboo Crafts"]
    },
];
        ...
        <section className="py-32 bg-white relative">
            <div className="max-w-7xl mx-auto px-6">
                <div className="flex flex-col md:flex-row justify-between items-end mb-24 space-y-8 md:space-y-0">
                    <div className="max-w-2xl text-left">
                        ...
                        <h3 className="text-5xl md:text-7xl font-heading font-black leading-[0.95] tracking-tighter text-gray-900">
                            Top <br />
                            <span className="italic font-light text-brand-primary">Destinations</span>
                        </h3>
                    </div>
                    <div className="flex flex-col items-end space-y-8">
                        <div className="hidden md:block">
                            <p className="text-gray-400 text-sm max-w-xs italic leading-relaxed border-l border-brand-primary/20 pl-6 text-left">
                                "From the bustling capital to the sacred valleys, every corner of Bhutan whispers a story of ancient wisdom."
                            </p>
                        </div>
                        <button className="group relative border border-brand-primary/20 text-brand-primary px-10 py-5 overflow-hidden transition-all duration-500 shadow-lg shadow-brand-primary/5 hover:border-brand-primary">
                            <span className="relative z-10 text-[10px] font-bold tracking-[0.4em] uppercase group-hover:text-brand-primary-fg transition-colors duration-500">View All Locations</span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-20 lg:mb-32">
                    ...
                    >
                        <Image src={destinations[0].image} alt="Paro" fill className="object-cover group-hover:scale-110 transition-transform duration-1000" />
                        ...
                        <div className="absolute bottom-10 left-10">
                            <span className="text-white font-black text-3xl uppercase tracking-tighter drop-shadow-2xl flex items-center">
                                {destinations[0].name} <ArrowRight className="ml-4 h-6 w-6 opacity-0 -translate-x-4 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-500 text-brand-primary" />
                            </span>
                            <p className="text-white/60 text-[10px] uppercase tracking-[0.4em] mt-2 font-medium">{destinations[0].tag}</p>
                        </div>
                    </div>
                    ...
                    >
                        <Image src={destinations[1].image} alt="Thimphu" fill className="object-cover group-hover:scale-110 transition-transform duration-1000" />
                        <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-60 group-hover:opacity-80 transition-opacity" />
                        <div className="absolute bottom-8 left-8">
                            <span className="text-white font-black text-xl uppercase tracking-tighter">{destinations[1].name}</span>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        className="relative aspect-square group overflow-hidden bg-gray-100 rounded-sm shadow-2xl shadow-brand-primary/5 cursor-pointer"
                    >
                        <Image src={destinations[2].image} alt="Punakha" fill className="object-cover group-hover:scale-110 transition-transform duration-1000" />
                        <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-60 group-hover:opacity-80 transition-opacity" />
                        <div className="absolute bottom-8 left-8">
                            <span className="text-white font-black text-xl uppercase tracking-tighter">{destinations[2].name}</span>
                        </div>
                    </div>
                    ...
                    <div className="md:col-span-2 grid grid-cols-2 gap-6">
                        ...
                        >
                            <Image src={destinations[3].image} alt="Phuntsholing" fill className="object-cover group-hover:scale-110 transition-transform duration-1000" />
                            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-60 group-hover:opacity-80 transition-opacity" />
                            <div className="absolute bottom-8 left-8">
                                <span className="text-white font-black text-xl uppercase tracking-tighter leading-none">{destinations[3].name}</span>
                            </div>
                        </div>
                        <div
                            ...
                            className="relative aspect-[16/10] group overflow-hidden bg-gray-100 rounded-sm shadow-2xl shadow-brand-primary/5 cursor-pointer"
                        >
                            <Image src={destinations[4].image} alt="Wangdue" fill className="object-cover group-hover:scale-110 transition-transform duration-1000" />
                            <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-60 group-hover:opacity-80 transition-opacity" />
                            <div className="absolute bottom-8 left-8">
                                <span className="text-white font-black text-xl uppercase tracking-tighter leading-none">{destinations[4].name}</span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        >
                            ...
                            <div className="w-full md:w-[55%] p-10 lg:p-14 flex flex-col justify-center bg-white overflow-y-auto">
                                ...
                                <div className="flex items-center text-brand-primary gap-3 mb-8">
                                    ...
                                    <span className="text-[10px] font-bold uppercase tracking-[0.4em]">{selectedDest.tag}</span>
                                </div>
                                ...
                                <div className="mt-8">
                                    ...
                                    >
                                        <span className="relative z-10 text-[9px] font-bold tracking-[0.3em] uppercase group-hover:text-white transition-colors duration-500">Plan Visit</span>
