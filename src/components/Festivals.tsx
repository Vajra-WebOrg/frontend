...
const festivals = [
  {
    ...
    location: "Thimphu",
    image: "/thimphuTshechu.jpg",
    longDesc:
      "One of the biggest festivals in the country, the Thimphu Tshechu is held at the courtyard of the Tashichho Dzong. It's a grand display of Bhutanese culture, featuring sacred Cham dances, religious blessings, and social gatherings.",
    details: [
      "Sacred Mask Dances",
      "Display of Thangka",
      "Religious Blessings",
  ...
  },
  {
    ...
    location: "Paro",
    image: "/paroTsechu.jpg",
    longDesc:
      "Held every spring, the Paro Tshechu is a vibrant spectacle. The highlight is the unveiling of the giant silk Thangka (Thongdrel) of Guru Rinpoche, believed to liberate all who see it.",
    details: [
      "Giant Thangka Unveiling",
      "Traditional Gho & Kira",
      "Local Cuisines",
  ...
  },
  {
    ...
    location: "Punakha",
    image: "/punakhaDrup.jpg",
    longDesc:
      "The Punakha Domche features a dramatic re-enactment of the 17th-century battle against invading forces. Held at the majestic Punakha Dzong, it's a powerful display of Bhutan's history.",
    details: [
      "Battle Re-enactment",
  ...
  },
  {
    ...
    location: "Bumthang",
    image: "/jambayLhakhang.jpg",
    longDesc:
      "Famous for the 'Mewang' (Fire Blessing) and the sacred 'Tercham' (Naked Dance), this festival held at one of Bhutan's oldest temples is a deeply spiritual experience representing purification.",
    details: [
      "Fire Blessing Ceremony",
      "Sacred Night Dances",
      "Ancient Temple Setting",
  ...
  },
  {
    ...
    date: "November 11",
    location: "Gangtey",
    image: "/craneFestival.jpg",
    longDesc:
      "Celebrating the arrival of the endangered Black-Necked Cranes to Phobjikha Valley. Local school children perform crane dances, promoting conservation and the deep bond between nature and culture.",
    details: [
      "Black-Necked Crane Dances",
      "Nature Conservation",
      "Phobjikha Valley",
  ...
  },
  {
    ...
    location: "Haa Valley",
    image: "/haaSummerFestival.jpg",
    longDesc:
      "A celebration of traditional nomadic lifestyles, Bhutanese cuisine, and local sports. Experience the high-altitude flora, sample local Ara (spirit), and join in traditional horse riding events.",
    details: [
      "Nomadic Lifestyle",
      "Traditional Sports",
      "Alpine Flowers",
...
export default function Festivals() {
  ...
  const [selectedFes, setSelectedFes] = useState<(typeof festivals)[0] | null>(
    null,
  );
        ...
        <div className="flex flex-col md:flex-row justify-between items-end space-y-8 md:space-y-0 text-left">
          ...
          <div className="hidden md:block">
            <p className="text-gray-400 text-sm max-w-xs italic leading-relaxed border-l border-brand-primary/20 pl-6">
              &ldquo;Experience the vibrant heart of Bhutanese culture through sacred
              mask dances and communal joy.&rdquo;
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="relative">
        <div className="flex items-center justify-center space-x-0 md:space-x-12 px-4 relative max-w-[1400px] mx-auto">
          ...
          <div className="flex items-center space-x-4 md:space-x-12 overflow-visible py-10">
            {[-1, 0, 1].map((offset) => {
              const index =
                (activeIndex + offset + festivals.length) % festivals.length;
              ...
              return (
                <motion.div
                  ...
                  layout
                  onClick={() =>
                    isActive ? setSelectedFes(fes) : setActiveIndex(index)
                  }
                  ...
                  {isActive && (
                    ...
                    >
                      ...
                      <div className="flex flex-col items-center gap-1">
                        ...
                        <p className="text-xs text-gray-400 italic font-light tracking-widest">
                          {fes.location}, Bhutan
                        </p>
                      </div>
                    </motion.div>
